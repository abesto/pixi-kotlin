...
(function (c) {
    ...
    function p(a, b) {
        ...
        for (var d in a) {
            a.hasOwnProperty(d) && ("function" === typeof a[d] ? a[d].type === c.TYPE.INIT_FUN ? (a[d].className = d, Object.defineProperty(b, d, {
                get: a[d],
                configurable: !0
            })) : b[d] = a[d] : Object.defineProperty(b, d, a[d]));
        }
        return b;
    }
...
(function (c) {
    ...
    var g = c.createClassNow(null, null, {
        println: function (a) {
    ...
    c.OutputToConsoleLog = c.createClassNow(g, null, {
        print: function (a) {
            console.log(a);
        }, println: function (a) {
...
(function (c) {
    ...
    Object.defineProperty(c, "ComplexHashMap", {
        get: function () {
            return c.HashMap;
        }
    });
    ...
    Object.defineProperty(c, "ComplexHashSet", {
        get: function () {
            return c.HashSet;
        }
    });
...
(function (c) {
    var f = c.defineRootPackage(null, {
        kotlin: c.definePackage(null, {
            Iterable: c.createTrait(null),
            MutableIterable: c.createTrait(function () {
            ...
            Map: c.createTrait(null),
            MutableMap: c.createTrait(function () {
                return [f.kotlin.Map];
            }),
            Iterator: c.createTrait(null),
            MutableIterator: c.createTrait(function () {
            ...
            ExtensionFunction0: c.createTrait(null),
            ExtensionFunction1: c.createTrait(null),
            ExtensionFunction2: c.createTrait(null),
            ExtensionFunction3: c.createTrait(null),
            ExtensionFunction4: c.createTrait(null),
            ExtensionFunction5: c.createTrait(null),
            ExtensionFunction6: c.createTrait(null),
            ExtensionFunction7: c.createTrait(null),
            ExtensionFunction8: c.createTrait(null),
            ExtensionFunction9: c.createTrait(null),
            ExtensionFunction10: c.createTrait(null),
            ExtensionFunction11: c.createTrait(null),
            ExtensionFunction12: c.createTrait(null),
            ExtensionFunction13: c.createTrait(null),
            ExtensionFunction14: c.createTrait(null),
            ExtensionFunction15: c.createTrait(null),
            ExtensionFunction16: c.createTrait(null),
            ExtensionFunction17: c.createTrait(null),
            ExtensionFunction18: c.createTrait(null),
            ExtensionFunction19: c.createTrait(null),
            ExtensionFunction20: c.createTrait(null),
            ExtensionFunction21: c.createTrait(null),
            ExtensionFunction22: c.createTrait(null),
            Function0: c.createTrait(null),
            Function1: c.createTrait(null),
            Function2: c.createTrait(null),
            Function3: c.createTrait(null),
            Function4: c.createTrait(null),
            Function5: c.createTrait(null),
            Function6: c.createTrait(null),
            Function7: c.createTrait(null),
            Function8: c.createTrait(null),
            Function9: c.createTrait(null),
            Function10: c.createTrait(null),
            Function11: c.createTrait(null),
            Function12: c.createTrait(null),
            Function13: c.createTrait(null),
            Function14: c.createTrait(null),
            Function15: c.createTrait(null),
            Function16: c.createTrait(null),
            Function17: c.createTrait(null),
            Function18: c.createTrait(null),
            Function19: c.createTrait(null),
            Function20: c.createTrait(null),
            Function21: c.createTrait(null),
            Function22: c.createTrait(null),
...
(function (c) {
    var f = c.defineRootPackage(null, {
        kotlin: c.definePackage(function () {
            ...
            js: c.definePackage(null, {
            ...
            }), get_lastIndex_l1lu5s$: {
                value: function (a) {
                    return a.length - 1;
                }
            }, get_lastIndex_964n92$: {
                value: function (a) {
                    return a.length - 1;
                }
            }, get_lastIndex_i2lc78$: {
                value: function (a) {
                    return a.length - 1;
                }
            }, get_lastIndex_tmsbgp$: {
                value: function (a) {
                    return a.length - 1;
                }
            }, get_lastIndex_se6h4y$: {
                value: function (a) {
                    return a.length - 1;
                }
            }, get_lastIndex_rjqrz0$: {
                value: function (a) {
                    return a.length - 1;
                }
            }, get_lastIndex_bvy38t$: {
                value: function (a) {
                    return a.length - 1;
                }
            }, get_lastIndex_355nu0$: {
                value: function (a) {
                    return a.length - 1;
                }
            }, get_lastIndex_eg9ybj$: {
                value: function (a) {
                    return a.length - 1;
                }
                ...
                todo_un3fny$: function (f) {
                    ...
                    assertTrue_ivxn3r$: function (c, f) {
                        ok(f, c);
                    ...
                    return l;
                }, Asserter: c.createTrait(null)
            }), reflect: c.definePackage(null, {
                KCallable: c.createTrait(null, {
                    name: {
                        get: function () {
            ...
            }), support: c.definePackage(null, {
                State: c.createEnumClass(function () {
                    return [c.Enum];
                }, function l() {
                    l.baseInitializer.call(this);
                }, function () {
                    return {
                        Ready: new f.kotlin.support.State,
                        NotReady: new f.kotlin.support.State,
                        Done: new f.kotlin.support.State,
                        Failed: new f.kotlin.support.State
                    };
            ...
            }), platform: c.definePackage(null, {
                platformName: c.createClass(function () {
                    return [c.modules.builtins.kotlin.Annotation];
                }, function (c) {
                    this.name = c;
            ...
            }), properties: c.definePackage(function () {
                this.Delegates = c.createObject(null, null, {
                    notNull: function () {
                ...
                ReadOnlyProperty: c.createTrait(null),
                ReadWriteProperty: c.createTrait(null),
                observable_d5k00n$f: function (c) {
                ...
                ChangeListener: c.createTrait(null),
                ChangeSupport: c.createClass(null, function () {
        ...
        org: c.definePackage(null, {w3c: c.definePackage(null, {dom: c.definePackage(null, {events: c.definePackage(null, {EventListener: c.createTrait(null)})})})}),
        java: c.definePackage(null, {
            io: c.definePackage(null, {Serializable: c.createTrait(null)}), util: c.definePackage(null, {
                HashSet_4fm7v2$: function (f) {
