...
import net.abesto.kotlin.js.pixi.BitmapTextStyle
...
fun main(args: Array<String>) {
    fun init()
    {
        ...
        var textSample = PIXI.Text("Pixi.js can has\nmultiline text!",
                {
                    val s = TextStyle()
                    s.font = "35px Snippet"
                    s.fill = "white"
        ...
        var spinningText = PIXI.Text("I'm fun!", {
            val s = TextStyle()
        ...
        var countingText = PIXI.Text("COUNT 4EVAR: 0", {
            val s = TextStyle()
        ...
        var loader = PIXI.AssetLoader(assetsToLoader)

        // use callback
        fun onAssetsLoaded()
        {
            val bitmapFontText = PIXI.BitmapText("bitmap fonts are\n now supported!", {
