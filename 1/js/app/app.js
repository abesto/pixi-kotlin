(function (Kotlin) {
          ...
          js: Kotlin.definePackage(null, /** @lends _.net.abesto.kotlin.js */ {
            pixi: Kotlin.definePackage(null, /** @lends _.net.abesto.kotlin.js.pixi */ {
              examples: Kotlin.definePackage(null, /** @lends _.net.abesto.kotlin.js.pixi.examples */ {
                example1: Kotlin.definePackage(null, /** @lends _.net.abesto.kotlin.js.pixi.examples.example1 */ {
                  ...
                  main$animate: function (bunny, renderer, stage) {
                    return function animate() {
                      requestAnimFrame(_.net.abesto.kotlin.js.pixi.examples.example1.animate$f(animate));
                  ...
                  main: function (args) {
                    ...
                    var animate = _.net.abesto.kotlin.js.pixi.examples.example1.main$animate(bunny, renderer, stage);
                    document.body.appendChild(renderer.view);
                    requestAnimFrame(_.net.abesto.kotlin.js.pixi.examples.example1.main$f(animate));
                    bunny.anchor.x = 0.5;
                    bunny.anchor.y = 0.5;
  ...
  _.net.abesto.kotlin.js.pixi.examples.example1.main([]);
}(Kotlin));
