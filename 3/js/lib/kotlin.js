...
(function() {
  ...
  Kotlin.createEnumClass = function(a, b, c, d, e) {
    e = e || {};
    e.object_initializer$ = function() {
      var a = c(), b = 0, p = [], q;
      for (q in a) {
    ...
    e.valueOf_61zpoe$ = function(a) {
      return this.object[a];
    };
    return Kotlin.createClass(a, b, d, e);
  };
...
(function() {
  ...
  Kotlin.compareTo = function(a, b) {
    var c = typeof a;
    return "number" == c || "string" == c ? a < b ? -1 : a > b ? 1 : 0 : a.compareTo_za3rmp$(b);
  };
